...
class Calculator extends WindowAdapter implements ActionListener
{
   ...
   public Calculator(int width, int height, String Title)
   {
      ...
      mainframe.setLayout(null); // look and feel
    ...
    public void actionPerformed(ActionEvent obj)
    {
        try
        {
            no1 = Integer.parseInt(t1.getText()); // get data from t1
            no2 = Integer.parseInt(t2.getText());   // get data from t2

            if(obj.getSource() == b1)   // kuthal button dabal ki kai hot
            {
...
class Calculator01
{
    ...
    {
        Calculator cobj = new Calculator(400,400,"Marvellous Calulator");
    }
}